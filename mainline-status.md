...
| HDMI Input                   | {+ 6.15-rc1 +} | `n/a`          | sent           | {- TODO -}     | [PATCHv14](https://lore.kernel.org/linux-rockchip/20250306072842.287142-1-dmitry.osipenko@collabora.com/) |
|  - CEC                       | {+ 6.15-rc1 +} | `n/a`          | `n/a`          | `n/a`          | DONE  |
