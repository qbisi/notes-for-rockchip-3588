...
| PHY usbdp                | [#3](https://gitlab.collabora.com/hardware-enablement/rockchip-3588/linux/-/issues/3)   | {+ 6.10-rc1 +}  | sent           | sent           | sent           | [PATCHv5](https://lore.kernel.org/all/20240408225109.128953-1-sebastian.reichel@collabora.com/) |
...
| NPU                      |                                                                                         | {- TODO -}      | `n/a`          | `n/a`          | `n/a`          | being reverse engineered by Tomeu Vizoso: [blog post 1](https://blog.tomeuvizoso.net/2024/03/rockchip-npu-update-1-walk-in-park.html), [blog post 2](https://blog.tomeuvizoso.net/2024/03/rockchip-npu-update-2-mobilenetv1-is.html), [downstream kernel driver](https://github.com/friendlyarm/kernel-rockchip/commits/nanopi6-v6.1.y/drivers/rknpu) |
