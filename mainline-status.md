...
|                              | SoC            | Rock 5A        | Rock 5B        | EVB1           | Notes |
| ---------------------------- | -------------- | -------------- | -------------- | -------------- | ----- |
...
| PHY usbdp                    | {+ 6.10-rc1 +} | {+ 6.10-rc1 +} | {+ 6.10-rc1 +} | {+ 6.10-rc1 +} | DONE  |
| PMIC (rk806)                 | `n/a`          | {+ 6.6-rc1 +}  | {+ 6.5-rc1 +}  | {+ 6.5-rc1 +}  | DONE  |
| I2C Regulator (rk8602)       | `n/a`          | {+ 6.6-rc1 +}  | {+ 6.4-rc1 +}  | `n/a`          | DONE  |
| cpufreq                      | {+ 6.11-rc1 +} | {+ 6.11-rc1 +} | {+ 6.11-rc1 +} | {+ 6.11-rc1 +} | DONE  |
...
| USB 3 DRD                    | {+ 6.10-rc1 +} | {+ 6.10-rc1 +} | {+ 6.10-rc1 +} | {+ 6.10-rc1 +} | DONE  |
| USB 3 Host                   | {+ 6.7-rc1 +}  | {+ 6.8-rc1 +}  | {+ 6.8-rc1 +}  | `n/a`          | DONE  |
| USB-C (fusb302)              | `n/a`          | `n/a`          | sent           | {+ 6.10-rc1 +} | [PATCHv1](https://lore.kernel.org/linux-rockchip/20241210163615.120594-1-sebastian.reichel@collabora.com/) |
...
| HDMI Input                   | sent           | `n/a`          | sent           | {- TODO -}     | [PATCHv13](https://lore.kernel.org/linux-rockchip/20250304085819.108067-1-dmitry.osipenko@collabora.com/) |
|  - CEC                       | sent           | `n/a`          | `n/a`          | `n/a`          | [PATCHv13](https://lore.kernel.org/linux-rockchip/20250304085819.108067-1-dmitry.osipenko@collabora.com/) |
|  - Audio                     | {- TODO -}     | `n/a`          | `n/a`          | `n/a`          |       |
|  - HDCP                      | {- TODO -}     | `n/a`          | `n/a`          | `n/a`          |       |
| **Video Capture (VICAP)**    | {- TODO -}     | `n/a`          | `n/a`          | `n/a`          | [PATCHv4 for RK3568](https://lore.kernel.org/linux-rockchip/20250219-v6-8-topic-rk3568-vicap-v4-0-e906600ae3b0@wolfvision.net/) |
...
|   -- H.265                   | WIP            | `n/a`          | `n/a`          | `n/a`          | WIP by Detlev Casanova |
 ...
 * Improved USB-C Orientation handling: [PATCHv1](https://lore.kernel.org/linux-rockchip/20250225184519.3586926-1-heiko@sntech.de/)
 * HDMI PHY color depth management: [PATCHv3](https://lore.kernel.org/linux-rockchip/20250223-phy-sam-hdptx-bpc-v3-0-66a5c8e68327@collabora.com/)
