...
| PHY MIPI CSI DCPHY (samsung) | sent           | `n/a`          | `n/a`          | `n/a`          | `n/a`          | [PATCHv1](https://lore.kernel.org/linux-rockchip/20260721-dcphy-rx-v1-v1-0-4fc83c0ccac9@gmail.com/) |
...
|  -- HDMI 4K60 support        | sent           | `n/a`          | `n/a`          | `n/a`          | `n/a`          | [PATCHv8](https://lore.kernel.org/linux-rockchip/20260702-dw-hdmi-qp-scramb-v8-0-d79890d00b6a@collabora.com/) |
...
| - DP1.4 USB-C AltMode        | WIP            | `n/a`          | {- TODO -}     | {- TODO -}     | {- TODO -}     | [PATCHv3](https://lore.kernel.org/linux-rockchip/20260612-synopsys-dw-dp-improvements-v3-0-dc61e6352508@collabora.com/) |
|  -- DP Bridge                | {+ 6.18-rc1 +} | `n/a`          | {- TODO -}     | {- TODO -}     | {- TODO -}     | DONE, some DT binding updates required for proper USB-C AltMode support |
|    -- Audio                  | sent           | `n/a`          | {- TODO -}     | {- TODO -}     | {- TODO -}     | [PATCHv3](https://lore.kernel.org/linux-rockchip/20260612-synopsys-dw-dp-improvements-v3-0-dc61e6352508@collabora.com/) |
...
| CAN                          | sent           | `n/a`          | `n/a`          | `n/a`          | `n/a`          | [PATCHv4](https://lore.kernel.org/linux-can/tencent_EF20BAF99D37B9D3B0C9FC254C8FAC04680A@qq.com/) |
...
|   -- H.264                   | WIP            | `n/a`          | `n/a`          | `n/a`          | `n/a`          | Detlev Casanova and Daniel Almeida are working on rkvenc, which will use Mesa and Vulkan Video API and thus it will be quite different from existing V4L2 codec drivers. |
 ...
 * PCIe wake signal support: [PATCHv12](https://lore.kernel.org/linux-pci/20260707-wakeirq_support-v12-1-b4453f5bcc97@oss.qualcomm.com/)
 ...
 * HDMI PHY clock fixes: [PATCHv4](https://lore.kernel.org/linux-rockchip/20260612-hdptx-clk-fixes-v4-0-ce5e1d456cda@collabora.com/)
 ...
 * SCDC information to connector debugfs: [PATCHv7](https://lore.kernel.org/dri-devel/20260721-scdc-link-health-v7-0-92df1b6ad5fc@collabora.com/)
