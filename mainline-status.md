...
|  -- HDMI PHY             | [#5](https://gitlab.collabora.com/hardware-enablement/rockchip-3588/linux/-/issues/5)   | {+ 6.9-rc1 +}   | {- TODO -}     | ready          | ready          | [PATCHv2 for clk provider extension (6.12-rc1)](https://lore.kernel.org/all/20240620-rk3588-hdmiphy-clkprov-v2-0-6a2d2164e508@collabora.com/) |
|  -- HDMI Bridge          | [#5](https://gitlab.collabora.com/hardware-enablement/rockchip-3588/linux/-/issues/5)   | sent            | {- TODO -}     | WIP            | WIP            | [PATCHv3](https://lore.kernel.org/all/20240807-b4-rk3588-bridge-upstream-v3-0-60d6bab0dc7c@collabora.com/) |
