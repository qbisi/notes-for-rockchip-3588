...
|  -- HDMI 4K support      |                                                                                         | {+ 6.15-rc1 +}  | `n/a`          | `n/a`          | `n/a`          | [PATCHv3](https://lore.kernel.org/all/20250204-vop2-hdmi0-disp-modes-v3-0-d71c6a196e58@collabora.com/) |
|  -- HDMI FRL support     |                                                                                         | {- TODO -}      | `n/a`          | `n/a`          | `n/a`          |       |
|  -- HDMI 8K support      |                                                                                         | {- TODO -}      | `n/a`          | `n/a`          | `n/a`          |       |
|  -- HDMI Audio           |                                                                                         | sent            | {- TODO -}     | sent           | {- TODO -}     | [PATCHv5](https://lore.kernel.org/linux-rockchip/20250203171925.126309-1-detlev.casanova@collabora.com/) |
...
|  -- eDP PHY              |                                                                                         | sent            | `n/a`          | `n/a`          | `n/a`          | [PATCHv6](https://lore.kernel.org/linux-rockchip/20250121062324.309592-1-damon.ding@rock-chips.com/) |
...
| Random Number Generator  |                                                                                         | sent            | `n/a`          | `n/a`          | `n/a`          | [PATCHv2](https://lore.kernel.org/linux-rockchip/20250204-rk3588-trng-submission-v2-0-608172b6fd91@collabora.com/) |
...
| SPDIF                    |                                                                                         | sent            | `n/a`          | `n/a`          | `n/a`          | [PATCHv1](https://lore.kernel.org/linux-rockchip/20250120-rk3588-spdif-v1-0-1415f5871dc7@gmail.com/) |
