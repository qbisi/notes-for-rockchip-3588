...
| HDMI Input                   | {+ 6.15-rc1 +} | `n/a`          | {+ 6.15-rc1 +} | {+ 6.16-rc1 +} | {- TODO -}     |       |
 ...
 * PCIe slot reset on link down: [PATCHv1](https://lore.kernel.org/all/20250430-b4-pci_dwc_reset_support-v1-1-f654abfa7925@wdc.com/)
