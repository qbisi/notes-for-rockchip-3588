...
|  -- HDMI 4K60 support        | sent           | `n/a`          | `n/a`          | `n/a`          | `n/a`          | [PATCHv2](https://lore.kernel.org/linux-rockchip/20260113-dw-hdmi-qp-scramb-v2-0-ae7b2c58d24d@collabora.com/) |
...
| RGA3                         | sent           | `n/a`          | `n/a`          | `n/a`          | `n/a`          | [PATCHv2](https://lore.kernel.org/linux-rockchip/20251203-spu-rga3-v2-0-989a67947f71@pengutronix.de/) |
...
|  - MIPI CSI Hosts            | WIP            | `n/a`          | `n/a`          |`n/a`           | `n/a`          | [PATCHv6](https://lore.kernel.org/linux-rockchip/20251114-rockchip-mipi-receiver-v6-0-b7ce6e68b3fa@collabora.com/) |
...
|   -- H.264                   | {+ 6.20-rc1 +} | `n/a`          | `n/a`          | `n/a`          | `n/a`          | [PR for 6.20](https://lore.kernel.org/linux-media/78bfd01051ef84ef7e6ccbd0a72301a939869476.camel@collabora.com/) |
|   -- H.265                   | {+ 6.20-rc1 +} | `n/a`          | `n/a`          | `n/a`          | `n/a`          | [PR for 6.20](https://lore.kernel.org/linux-media/78bfd01051ef84ef7e6ccbd0a72301a939869476.camel@collabora.com/) |
