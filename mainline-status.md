...
|  -- HDMI 4K60 support        | sent           | `n/a`          | `n/a`          | `n/a`          | `n/a`          | [PATCHv4 RESEND](https://lore.kernel.org/linux-rockchip/20260323-dw-hdmi-qp-scramb-v4-0-1d99df84883e@collabora.com/) |
...
| ISP                          | WIP            | `n/a`          | `n/a`          | `n/a`          | `n/a`          | [stripped down simplified driver](https://github.com/rockchip-community/linux/tree/rkisp30-driver) |
...
|  - MIPI CSI Hosts            | {+ 7.0-rc1 +}  | `n/a`          | `n/a`          | `n/a`          | `n/a`          | [PATCHv4 with DT updates for RK3588](https://lore.kernel.org/linux-rockchip/20260305-rk3588-csi2rx-v4-0-81c6bcfefa63@collabora.com/) |
 ...
 * USBDP PHY fixes for DisplayPort usage: [PATCHv3](https://lore.kernel.org/linux-rockchip/20260313-rockchip-usbdp-cleanup-v3-0-3e8fe89a35b5@collabora.com/)
 ...
 * Move rkvdec from bitfield to bitwriter: [PATCHv2](lore.kernel.org/linux-rockchip/20260327-rkvdec-use-bitwriter-v2-0-a5a4754b0518@collabora.com/)
