...
| PHY MIPI CSI DCPHY (samsung) | sent           | `n/a`          | `n/a`          | `n/a`          | `n/a`          | [PATCHv4](https://lore.kernel.org/linux-rockchip/20260821-dcphy-rx-v1-v4-0-f1797634233d@gmail.com/) |
...
|  -- HDMI 4K60 support        | sent           | `n/a`          | `n/a`          | `n/a`          | `n/a`          | [PATCHv11](https://lore.kernel.org/linux-rockchip/20260901-dw-hdmi-qp-scramb-v11-0-bc12954a0688@collabora.com/) |
...
| - DP1.4 USB-C AltMode        | WIP            | `n/a`          | {- TODO -}     | {- TODO -}     | {- TODO -}     | [PATCHv11](https://lore.kernel.org/linux-rockchip/20260806-synopsys-dw-dp-improvements-v11-0-0d508505f383@collabora.com/) |
|  -- DP Bridge                | {+ 6.18-rc1 +} | `n/a`          | {- TODO -}     | {- TODO -}     | {- TODO -}     | DONE, some DT binding updates required for proper USB-C AltMode support |
|    -- Audio                  | sent           | `n/a`          | {- TODO -}     | {- TODO -}     | {- TODO -}     | [PATCHv11](https://lore.kernel.org/linux-rockchip/20260806-synopsys-dw-dp-improvements-v11-0-0d508505f383@collabora.com/) |
...
| HW crypto engine             | sent           | `n/a`          | `n/a`          | `n/a`          | `n/a`          | [PATCHv3](https://lore.kernel.org/linux-rockchip/20260816194112.552100-1-dawidro@gmail.com/) |
...
| CAN                          | {+ 7.3-rc1 +}  | `n/a`          | `n/a`          | `n/a`          | `n/a`          | DONE  |
...
|   -- JPEG                    | sent           | `n/a`          | `n/a`          | `n/a`          | `n/a`          | [PATCHv4](https://lore.kernel.org/linux-media/20260918-rockchip-jpegdec-v4-0-0dd97df47abb@pengutronix.de/) |
 ...
 * NPU: DVFS support: [PATCHv2](https://lore.kernel.org/linux-rockchip/20260922080114.44662-1-royalnet026@gmail.com/)
 * PCIe System PM support: [PATCHv6](https://lore.kernel.org/linux-rockchip/20260908-rockchip-pcie-system-suspend-v6-0-fbabcca9921b@collabora.com/)
 ...
 * USBDP PHY fixes for DisplayPort usage: [PATCHv14](https://lore.kernel.org/linux-phy/20260813-rockchip-usbdp-cleanup-v14-0-b5ad9c68fa11@collabora.com/)
 ...
 * HDMI 10-bit YUV422 and YUV420 support: [PATCHv4](https://lore.kernel.org/linux-rockchip/20260903-dw-hdmi-qp-yuv-v4-0-fb45bf4147eb@collabora.com/)
 * HDMI Variable Refresh Rate (VRR): [RFCv1](https://lore.kernel.org/linux-rockchip/20260921-vrr-limiter-uapi-v1-0-2fcd7d011646@collabora.com/)
 ...
 * Race condition fix for DP AltMode negotiation (7.3-rc1): [PATCHv5](https://lore.kernel.org/all/20260717232612.3671978-2-rdbabiera@google.com/)
 ...
 * HDMI QP audio N/CTS cleanup and fix (7.4-rc1): [PATCHv3](https://lore.kernel.org/linux-rockchip/86fcf349-0a7a-4618-9001-612371b0f71b@symple.nz/)
