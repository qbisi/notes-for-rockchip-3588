...
|  -- HDMI PHY             | [#5](https://gitlab.collabora.com/hardware-enablement/rockchip-3588/linux/-/issues/5)   | {+ 6.9-rc1 +}   | {- TODO -}     | ready          | ready          | [PATCHv2 for clk provider extension](https://lore.kernel.org/all/20240620-rk3588-hdmiphy-clkprov-v2-0-6a2d2164e508@collabora.com/) |
|  -- HDMI Bridge          | [#5](https://gitlab.collabora.com/hardware-enablement/rockchip-3588/linux/-/issues/5)   | sent            | {- TODO -}     | WIP            | WIP            | [PATCH for bridge driver](https://lore.kernel.org/all/20240801-dw-hdmi-qp-tx-v1-0-148f542de5fd@collabora.com/), [PATCHv2 for glue code](https://lore.kernel.org/all/20240801-b4-rk3588-bridge-upstream-v2-0-9fa657a4e15b@collabora.com/) |
...
| CAN                      |                                                                                         | {- TODO -}      | `n/a`          | `n/a`          | `n/a`          | [PATCHv2 for RK3568](https://lore.kernel.org/linux-rockchip/20240731-rockchip-canfd-v2-0-d9604c5b4be8@pengutronix.de/T/#mffd834814e53cdd8658db500653e3a5dd3ffaf08) |
...
| HDMI Input               | [#4](https://gitlab.collabora.com/hardware-enablement/rockchip-3588/linux/-/issues/4)   | sent            | `n/a`          | sent           | {- TODO -}     | [PATCHv4](https://lore.kernel.org/all/20240719124032.26852-1-shreeya.patel@collabora.com/) |
|  - CEC                   | [#4](https://gitlab.collabora.com/hardware-enablement/rockchip-3588/linux/-/issues/4)   | sent            | `n/a`          | `n/a`          | `n/a`          | [PATCHv4](https://lore.kernel.org/all/20240719124032.26852-1-shreeya.patel@collabora.com/) |
...
|   -- JPEG                |                                                                                         | sent            | `n/a`          | `n/a`          | `n/a`          | [PATCHv7](https://lore.kernel.org/all/20240618183816.77597-1-sebastian.reichel@collabora.com/) |
...
|   -- VP8                 |                                                                                         | sent            | `n/a`          | `n/a`          | `n/a`          | [PATCHv7](https://lore.kernel.org/all/20240618183816.77597-1-sebastian.reichel@collabora.com/) |
|   -- MPEG-1              |                                                                                         | {- TODO -}      | `n/a`          | `n/a`          | `n/a`          |       |
|   -- MPEG-2              |                                                                                         | sent            | `n/a`          | `n/a`          | `n/a`          | [PATCHv7](https://lore.kernel.org/all/20240618183816.77597-1-sebastian.reichel@collabora.com/) |
|   -- MPEG-4              |                                                                                         | sent            | `n/a`          | `n/a`          | `n/a`          | [PATCHv7](https://lore.kernel.org/all/20240618183816.77597-1-sebastian.reichel@collabora.com/) |
